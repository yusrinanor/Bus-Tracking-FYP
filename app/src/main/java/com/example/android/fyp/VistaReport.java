...
public class VistaReport extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        reportAdapterAllFrom = new FirebaseRecyclerAdapter<Report, ReportHolder>(
                Report.class, R.layout.cardviewreport, ReportHolder.class, reportRef.child("VISTA-APU").orderByChild("from").equalTo("Vista") // select * from Report where route = endah-apu
        ) {
            @Override
        ...
        reportAdapterThisWeek = new FirebaseRecyclerAdapter<Report, ReportHolder>(
                Report.class, R.layout.cardviewreport, ReportHolder.class, reportRef.child("VISTA-APU").orderByChild("datetime").startAt(date_this_week).endAt(date_now) // select * from Report where route = scp-apu
        ) {
            @Override
            protected void populateViewHolder(ReportHolder viewHolder, Report model, int position) {
                viewHolder.txtDate.setText("");
        ...
        reportAdapterLastWeek = new FirebaseRecyclerAdapter<Report, ReportHolder>(
                Report.class, R.layout.cardviewreport, ReportHolder.class, reportRef.child("VISTA-APU").orderByChild("datetime").startAt(date_last_week).endAt(date_this_week) // select * from Report where route = endah-apu
        ) {
            @Override
            protected void populateViewHolder(ReportHolder viewHolder, Report model, int position) {
                viewHolder.txtDate.setText("");
        ...
        reportAdapterAllTo = new FirebaseRecyclerAdapter<Report, ReportHolder>(
                Report.class, R.layout.cardviewreport, ReportHolder.class, reportRef.child("VISTA-APU").orderByChild("to").equalTo("Vista") // select * from Report where route = endah-apu
        ) {
            @Override
            protected void populateViewHolder(ReportHolder viewHolder, Report model, int position) {
                viewHolder.txtDate.setText("");
        ...
        switchbutt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(destination_switch == "from"){
                    ...
                    filter_text.setText("All To Vista");
                } else {
