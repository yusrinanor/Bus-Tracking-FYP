    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_BusTracking:
                Intent bustracking = new Intent(DriverHome.this, DriverMapActivity.class);
                startActivity(bustracking);
                finish();
                return true;
            case R.id.nav_Feedback:
                Intent userFeedback = new Intent(DriverHome.this, FeedbackDriver.class);
                startActivity(userFeedback);
                finish();
                return true;
            case R.id.nav_Logout:
                FirebaseAuth.getInstance().signOut();
                Intent signoutIntent = new Intent(DriverHome.this, MainActivity.class);
